...
const log_acceso_entity_1 = require("./log-acceso.entity");
const bcrypt = __importStar(require("bcrypt"));
let AuthService = class AuthService {
    usuariosService;
    jwtService;
    logRepo;
    constructor(usuariosService, jwtService, logRepo) {
        this.usuariosService = usuariosService;
        this.jwtService = jwtService;
        this.logRepo = logRepo;
    }
    async login(username, password, ip, browser) {
    ...
    async logout(username, ip, browser) {
...
exports.AuthService = AuthService = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(log_acceso_entity_1.LogAcceso)),
